class Segment:
    ...
    def crossing(self, other):
        if self.alignment == other.alignment:
            return None
        if min(other.a[1], other.b[1]) <= self.a[1] <= max(other.a[1], other.b[1]) and min(self.a[0], self.b[0]) <= other.a[0] <= max(self.a[0], self.b[0]):
...
def build_wire(data):
    ...
    while len(data) > 0:
        ...
        seg_list.append(Segment((last_pos[0], last_pos[1]), (new_x, new_y)))
...
if __name__ == "__main__":
    ...
    crossings.pop(0)
    crossings.sort(key=dist_origin)
    print(crossings)
    print(dist_origin(crossings[0]))
